...
With VARIABLE SUBSCRIBERS and MULTIPLE PUBLISHERS
...
def save_multipath_results(all_simulation_data, num_subscribers, num_publishers):
    """Save simulation results"""
    os.makedirs('Simulation_Results/Multipath', exist_ok=True)
    filename = f'Simulation_Results/Multipath/RandomForest_{num_subscribers}sub_{num_publishers}pub_results.csv'
...
def plot_multipath_performance(all_results, num_subscribers):
    ...
    plt.suptitle(f'RandomForest Caching Policy Performance ({num_subscribers} Subscribers)',
        fontsize=14, fontweight='bold')
    plt.tight_layout()
...
def main():
    ...
    print("VARIABLE SUBSCRIBERS + MULTIPLE PUBLISHERS")
    print("RANDOMFOREST CACHING POLICY")
    print("="*70 + "\n")

    # Get user input for subscribers and iterations
    while True:
        try:
    ...
    # Run simulation
    print(f"Running simulation for {iterations} iterations with {num_subscribers} subscribers...\n")
    simulation_data = run_multipath_simulation(routers, publishers, subscribers, iterations)

    # Save results
    save_multipath_results(simulation_data, num_subscribers, num_publishers)

    # Plot performance
    print("Generating performance plots...\n")
    plot_multipath_performance(simulation_data, num_subscribers)
