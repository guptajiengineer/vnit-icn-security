...
- combined_results.csv: Saved to BOTH Algorithm1_Results/ and Simulation_Results/
- Individual policy CSVs: Saved ONLY to Algorithm1_Results/
- comparison_report.txt: Saved ONLY to Algorithm1_Results/
"""
...
def save_results_to_csv(df, filename='Algorithm1_Results/combined_results.csv'):
    """Save combined results to CSV in BOTH folders"""
    ...
    # Save to Algorithm1_Results
    df_reordered.to_csv(filename, index=False)
    print(f"✓ Saved combined results to: {filename}")

    # ALSO save to Simulation_Results (ONLY combined_results)
    sim_filename = filename.replace('Algorithm1_Results', 'Simulation_Results')
    df_reordered.to_csv(sim_filename, index=False)
    print(f"✓ Saved combined results to: {sim_filename}")
...
def save_policy_specific_csv(df):
    """Save individual CSV files for each policy (ONLY in Algorithm1_Results)"""
    os.makedirs('Algorithm1_Results', exist_ok=True)
...
def save_comparison_report(df):
    """Generate and save comparison report (ONLY in Algorithm1_Results)"""
    os.makedirs('Algorithm1_Results', exist_ok=True)
    ...
    # Save ONLY to Algorithm1_Results
...
if __name__ == "__main__":
    ...
    print("\nFile Structure:")
    print("\nAlgorithm1_Results/")
    print("   combined_results.csv (DUAL SAVED)")
    print("   LRU_results.csv (Algorithm1_Results only)")
    print("   LFU_results.csv (Algorithm1_Results only)")
    print("   FIFO_results.csv (Algorithm1_Results only)")
    print("   MRU_results.csv (Algorithm1_Results only)")
    print(" FACR_results.csv (Algorithm1_Results only)")
    print("   RandomForest_results.csv (Algorithm1_Results only)")
    print("   comparison_report.txt (Algorithm1_Results only)")
    print("\nSimulation_Results/")
    print("   combined_results.csv (DUAL SAVED)")
